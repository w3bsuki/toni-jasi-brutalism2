    ...
    <section className="w-full py-12 px-6 bg-white">
      ...
      <div className="max-w-7xl mx-auto mb-10">
        <h3 className="inline-block text-2xl md:text-3xl font-black uppercase tracking-tighter relative">
          BRANDS WE CARRY
          <div className="absolute h-3 w-4/5 bg-yellow-300 -bottom-1 left-0 z-0"></div>
        </h3>
      </div>
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center justify-between py-5 md:py-8 border-t-4 border-b-4 border-black px-4">
          {brands.map((brand, index) => (
            <React.Fragment key={brand}>
              ...
              >
                <div className="w-24 h-16 md:w-32 md:h-20 relative grayscale hover:grayscale-0 transition-all duration-300 flex items-center justify-center">
                  <div className="w-full h-full text-black hover:text-yellow-500 transition-colors duration-300 flex items-center justify-center">
                    <div className="font-bold text-lg md:text-xl uppercase tracking-tighter text-center">
                      {brand}
                    </div>
                  </div>
                </div>
